...
function UBlockIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
    ...
    >
      ...
      <div className="flex items-center gap-4 pr-6">
        <div className="text-sm">
          ...
          <p className="mt-1.5 flex flex-wrap items-center gap-1.5 text-[var(--fg-muted)]">
            <span>Use</span>
            <a
              className="inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1 font-medium text-white hover:opacity-90"
              style={{ background: "#fb542b" }}
              href="https://brave.com/"
              target="_blank"
              rel="noreferrer"
            >
              <BraveIcon size={18} /> Brave
            </a>
            <span>or</span>
            <a
              className="inline-flex items-center gap-1.5 rounded-lg px-2.5 py-1 font-medium text-white hover:opacity-90"
              ...
              rel="noreferrer"
            >
              <UBlockIcon size={18} /> uBlock Origin
            </a>
            <span>to stop unwanted popups and ads.</span>
          </p>
        </div>
      </div>
    </div>
